...
# --- Robust numeric array parser for 'img' column ---
def extract_numeric_array(s: str) -> np.ndarray:
    """
    Extract all numeric tokens from a stringified image array.
    Cleans artifacts like '...', '\n', and brackets.
    """
...
# --- Pad or truncate arrays so all have equal length ---
...
# PCA reduces feature size (helps Logistic Regression)
...
# --- Evaluate ---
y_pred = best_logreg.predict(X_test_p)
...
joblib.dump(best_logreg, "logreg.pkl")
joblib.dump(scaler, "logreg_scaler.pkl")
joblib.dump(pca, "logreg_pca.pkl")
print("\n Saved: logreg.pkl, logreg_scaler.pkl, logreg_pca.pkl")
